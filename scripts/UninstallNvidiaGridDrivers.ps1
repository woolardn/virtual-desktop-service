# Scripted Event Example, Uninstall Nvidia Grid Drivers
#
# Example Script Repository Settings
# Name: UninstallNvidiaGridDrivers
# Include Script File: Use Script File
# Import Script, Select a File: UninstallNvidiaGridDrivers.ps1
...
# Name: UninstallNvidiaGridDrivers
# Script: UninstallNvidiaGridDrivers
# Enabled
# Trigger On: Manual
...
if($ChocoInstalled) {
    choco uninstall cjanvidia_grid -y --force
} else {
