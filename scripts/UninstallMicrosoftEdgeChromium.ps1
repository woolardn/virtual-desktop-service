# Scripted Event Example, Uninstall Microsoft Edge Chromium
#
# Example Script Repository Settings
# Name: UninstallMicrosoftEdgeChromium
# Include Script File: Use Script File
# Import Script, Select a File: UninstallMicrosoftEdgeChromium.ps1
...
# Name: UninstallMicrosoftEdgeChromium
# Script: UninstallMicrosoftEdgeChromium
# Enabled
...
if($ChocoInstalled) {
    choco uninstall microsoft-edge -y --force
} else {
