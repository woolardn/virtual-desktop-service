...
. Send the report to cjsupport@netapp.com if you need assistance troubleshooting
...
. Capture the data by choosing “Save Image…” from the File Menu.
. Send that image to NetApp VDS support by attaching to your existing ticket or by creating a new ticket.
