...
|===
| Elements/Features| 	HTML5 Browser| 	Cloud Workspace Client for Windows| 	MacOS RDP Client| 	RDP Client on mobile devices| 	HTML5 Client on mobile devices
...
redirection. 	|Enabled through clipboard redirection. Inside the Cloud Workspace, use control + C or V instead of command + C or V. 	|Enabled through clipboard redirection. 	 |Enabled through clipboard redirection.
