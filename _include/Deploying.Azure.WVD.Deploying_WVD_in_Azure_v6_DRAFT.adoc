...
image:Deploying.Azure.WVD.Deploying_WVD_in_Azure_v6.image1.png[width=75%]


=== IaaS and platform
image:Deploying.Azure.WVD.Deploying_WVD_in_Azure_v6.image2.png[width=75%]
...
image:Deploying.Azure.WVD.Deploying_WVD_in_Azure_v6.image3.png[width=75%]
...
Azure NetApp Files has a 4TiB minimum while managed disks 
